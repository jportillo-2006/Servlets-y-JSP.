        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="/assets/image/ImagenCarrusel1.png" class="d-block w-100" alt="Celulares 1">
              </div>
              <div class="carousel-item">
                <img src="/assets/image/ImagenCarrusel2.png" class="d-block w-100" alt="Celulares 2">
              </div>
              <div class="carousel-item">
                <img src="/assets/image/ImagenCarrusel3.png" class="d-block w-100" alt="Celulares 3">
              </div>
            </div>
